                          ...
                          <tr><td colSpan={4} className="p-8 text-center text-slate-400">
                            ...
                            <button 
                              onClick={async () => {
                                const defaults = [
                                  // Day 1: 2026.05.15
                                  { date: "2026-05-15", time: "11:00 - 12:00", title: "НЭЭЛТИЙН ҮЙЛ АЖИЛЛАГАА", description: "" },
                                  { date: "2026-05-15", time: "12:00 - 13:00", title: "LIVE үзэсгэлэнд оролцогчдын шууд дамжуулалт", description: "" },
                                  
                                  // Day 2: 2026.05.16
                                  { date: "2026-05-16", time: "11:00 - 12:00", title: "LIVE үзэсгэлэнд оролцогчдын шууд дамжуулалт", description: "" },
                                  { date: "2026-05-16", time: "11:20 - 11:40", title: "Нийтэд хүртээмжтэй төлөвлөлт /АОС/", description: "Илтгэгч: В.Ойдов (Нийтэд Хүртээмжтэй Пассив Лаборатори Хауз төсөл санаачлагч)" },
                                  { date: "2026-05-16", time: "11:40 - 12:00", title: "Эрчим хүчний хэмнэлттэй барилгын дулаалга", description: "Илтгэгч: Мөнхбаяр (ШУТИС ЭХИС-ийн багш)" },
                                  { date: "2026-05-16", time: "12:00 - 12:20", title: "Эрчим хүчний хэмнэлттэй амины орон сууцны төлөвлөлт, зураг төсөлд тавигдах шаардлага", description: "Илтгэгч: Отгончимэг (Амины орон сууцны инновац хөгжлийн төв)" },
                                  { date: "2026-05-16", time: "12:20 - 12:40", title: "Хөрсний төрлүүдийн шинж чанар ба барилгын суурийн нөлөөлөл", description: "Илтгэгч: О.Балдорж (Монгол Улсын зөвлөх инженер, Гавьяат барилгачин)" },
                                  { date: "2026-05-16", time: "12:40 - 13:00", title: "Угсармал хийцийг амины орон сууцанд төлөвлөх нь", description: "Илтгэгч: Д.Энхтүвшин (Эн Си Ди Прекон ХХК Гүйцэтгэх захирал, Зөвлөх инженер)" },
                                  { date: "2026-05-16", time: "13:00 - 13:20", title: "Амины орон сууцны агаар сэлгэлтийг оновчтой төлөвлөх нь", description: "Илтгэгч: Ц.Уранцэцэг (БАC-ийн багш доктор, дэд профессор)" },
                                  { date: "2026-05-16", time: "13:20 - 13:40", title: "Амины орон сууцны төрөл хийцлэлийн сул ба давуу тал", description: "Танилцуулга: Хишигмөнх Барилгачин групп" },

                                  // Day 3: 2026.05.17
                                  { date: "2026-05-17", time: "11:00 - 12:00", title: "LIVE үзэсгэлэнд оролцогчдын шууд дамжуулалт", description: "" },
                                  { date: "2026-05-17", time: "12:00 - 12:20", title: "Нар + Батарейн системийг амины орон сууцанд ухаалгаар төлөвлөх нь", description: "Илтгэгч: Г.Бат-Эрдэнэ (Монкабел системс ХХК)" },
                                  { date: "2026-05-17", time: "12:20 - 12:40", title: "Эрүүл хөрс, бохирын найдвартай шийдэл", description: "Илтгэгч: С.Цэвэгсүрэн (ПЛАСТИК ЦЕНТР ХХК Ерөнхий захирал)" },
                                  { date: "2026-05-17", time: "12:40 - 13:00", title: "Пассив амины орон сууц гэж юу вэ?", description: "Илтгэгч: Ганбаа (Пассив барилгын хүрээлэн), А.Амарбаяр" },
                                  { date: "2026-05-17", time: "13:00 - 13:40", title: "\"Дулаалгын ач холбогдол ба шийдэл\"", description: "Илтгэгч: Ц.Түмэнбаяр (Хашаандаа сайхан амьдаръя)" },
                                  { date: "2026-05-17", time: "13:40 - 14:00", title: "Сэргээгдэх эрчим хүчээр халаалтаа шийдэх нь", description: "Илтгэгч: Ө.Отгонсүрэн (Грийн Солар ХХК)" },
                                  { date: "2026-05-17", time: "14:20 - 14:40", title: "Hybrid house гэж юу вэ?", description: "Илтгэгч: Ц.Бат-Эрдэнэ (HYBRID HOUSE LLC үүсгэн байгуулагч)" },
                                  { date: "2026-05-17", time: "14:40 - 15:00", title: "Санхүүгийн дэмжлэг үзүүлэх боломжууд", description: "Танилцуулга: Хамтарч ажиллаж буй банкууд" },
                                  { date: "2026-05-17", time: "15:00 - 15:30", title: "Ногоон барилгын үнэлгээний гэрчилгээ /BestGer/", description: "Илтгэгч: Ц.Батгэрэл (Ногоон барилгын хүрээлэн)" },
                                  { date: "2026-05-17", time: "15:30 - 16:00", title: "BIPV - Барилгыг эрчим хүч үйлдвэрлэгч болгох технологи", description: "Илтгэгч: С.Болорбайгаль (BIPV Glass технологийн сургагч)" },
                                  { date: "2026-05-17", time: "16:00 - 16:30", title: "ХААЛТЫН ҮЙЛ АЖИЛЛАГАА", description: "" },
                                ];
                                try {
                                  for (const item of defaults) {
